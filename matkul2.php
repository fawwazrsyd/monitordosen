   ...
   <table class="table table-dark table-striped table-hover table-bordered">
    ...
    <?php
      while($row = mysqli_fetch_array($records)) {
        if($row["kdmk"] == $_SESSION["kdmk2"] && $row["dosenid"] == $_SESSION["dosenid"] ){

      echo "<tr><form action=process2.php method=post>";
      ...
      <?php
      echo "<td><textarea style='width:250px;' row='3' cols='1' class='form-control' type=text name=alasan value='".$row['alasan']."'></textarea>  </td>";
